...
static stUwbAllConfigContainer s_Local_UwbAllConfigContainer = {
  ...
  .CB_SystemConfigContainer.antennaID           = EN_ANTENNA_0_0_3D, 
...
{
  return s_Local_UwbAllConfigContainer.CB_SystemConfigContainer.antennaID;
}
...
{
  s_Local_UwbAllConfigContainer.CB_SystemConfigContainer.antennaID = antennaIdx;
}

/**
 * @file    main.c
 * @brief   TDOA Anchor Responder main entry point.
 * @details Based on uwb_simple_tx template. Initialises SDK subsystems and
 *          enters the Responder application main loop.
 * @author  Chipsbank
 * @date    2026
 */
...
int main(void)
{
  ...
  app_uart_printf("[RESP] TDOA Responder v1.0\r\n");

...
#define FLASH_TEST_SECTOR           0x40            //0x40*4k = 0x00040000UL
...
/**
 * @brief   Flash encryption operation example for application layer
 * @details This example shows flash encryption operations:
 *          Enable Encryption -> Init -> GetInfo -> Erase -> Write -> Read -> Verify -> Disable Encryption
 *
 * @note    If encryption is NOT required, remove the two encryption API calls
 *          and use normal flash read/write operations.
 */
void app_flash_encryption_test_process(void)
{
...
//    app_uart_init();
    app_uart_printf("\n=============================================\n");
    app_uart_printf("\n     Flash Encryption App Example Start      \n");
    app_uart_printf("=============================================\n");
    ...
    // Step2: Enable Flash AES encryption function
    cb_flash_encryption_enable();
    app_uart_printf("[INFO] Flash encryption enabled\r\n");

    // Step3: Read Flash information (Vendor ID & Capacity)
    ...
    // Step4: Erase target flash sector
    ...
    // Step5: Write data to flash with encryption
    ...
    // Step6: Read data from flash (hardware decrypt automatically)
    ...
    // Step8: Disable Flash AES encryption function
    cb_flash_encrytpion_disable();
    app_uart_printf("[INFO] Flash encryption disabled\r\n");
		
	app_uart_printf("\r\n[INFO] All flash encryption operations passed\r\n");
    app_uart_printf("=============================================\r\n\r\n");
}

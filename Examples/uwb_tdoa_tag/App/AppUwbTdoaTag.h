/**
 * @file    AppUwbTdoaTag.h
 * @brief   TDOA tag example - public configuration and entry point declaration.
 * @details Centralises the tag role defaults, UWB packet configuration, and
 *          per-round timeout used by AppUwbTdoaTag.c.
 * @author  Chipsbank
 * @date    2026
 */

#ifndef __APP_UWB_TDOA_TAG_H
#define __APP_UWB_TDOA_TAG_H
...
//-------------------------------
/* Tag role defaults */
#define APP_TDOA_TAG_DEVICE_ID          4u
#define APP_TDOA_TAG_SLOT               0u

/* UWB packet configuration defaults used by the Tag application. */
#define APP_TDOA_TAG_PACKET_CONFIG_DEFAULTS                                  \
{                                                                            \
